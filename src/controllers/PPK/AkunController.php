...
class PPKAkunController
{
    ...
    public function index($options = [])
    {
        ...
        include __DIR__ . '/../../views/layouts/ppk/header.php';
        include __DIR__ . '/../../views/pages/ppk/akun.php';
        include __DIR__ . '/../../views/layouts/ppk/footer.php';
    }
    ...
    public function update()
    {
        if ($_SERVER['REQUEST_METHOD'] === 'POST') {
            ...
            header('Location: /docutrack/public/ppk/akun?success=1');
            exit;
        }

        header('Location: /docutrack/public/ppk/akun');
        exit;
    }
}