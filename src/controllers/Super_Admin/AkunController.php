<?php
// File: src/controllers/Super_Admin/AkunController.php

class SuperadminAkunController
{
    ...
    public function index($options = [])
    {
        ...
        $active_page = $options['active_page'] ?? '/super_admin/akun';
        
        include __DIR__ . '/../../views/layouts/super_admin/header.php';
        include __DIR__ . '/../../views/pages/super_admin/akun.php';
        include __DIR__ . '/../../views/layouts/super_admin/footer.php';
    }
    ...
    public function update()
    {
        if ($_SERVER['REQUEST_METHOD'] === 'POST') {
            ...
            if (!empty($_POST['password'])) {
                ...
                if ($newPassword === $confirmPassword) {
                    if (strlen($newPassword) >= 8) {
                        ...
                        header('Location: /docutrack/public/super_admin/akun?error=password_short');
                        exit;
                    }
                } else {
                    // Password tidak cocok
                    header('Location: /docutrack/public/super_admin/akun?error=password_mismatch');
                    exit;
                }
            }
            ...
            header('Location: /docutrack/public/super_admin/akun?success=1');
            exit;
        }
        
        // Jika bukan POST, redirect ke halaman akun
        header('Location: /docutrack/public/super_admin/akun');
        exit;
    }
}