...
class BendaharaAkunController
{
    ...
    public function index($options = [])
    {
        ...
        include __DIR__ . '/../../views/layouts/bendahara/header.php';
        include __DIR__ . '/../../views/pages/bendahara/akun.php';
        include __DIR__ . '/../../views/layouts/bendahara/footer.php';
    }
