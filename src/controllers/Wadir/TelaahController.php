<?php
// File: src/controllers/Wadir/WadirTelaahController.php
...
class WadirTelaahController extends Controller {
     ...
     * Ini adalah "sumber kebenaran" untuk Wadir.
    ...
    /**
     * Menampilkan HALAMAN DETAIL untuk Wadir menelaah KAK/RAB.
     * Dipanggil oleh rute: /wadir/telaah/show/{id}
     */
    public function show($id, $data_dari_router = []) {
        ...
        $data = array_merge($data_dari_router, [
            'title' => 'Persetujuan Wadir - ' . htmlspecialchars($usulan_dipilih['kak']['nama_kegiatan']),
            'status' => $status,
            'user_role' => $_SESSION['user_role'] ?? 'wadir', // <-- Mengirim 'wadir'
        ...
        // Panggil view 'telaah_detail' KHUSUS WADIR
        // dan gunakan layout 'wadir'
