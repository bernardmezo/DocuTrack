...
class WadirAkunController
{
    ...
    public function index($options = [])
    {
        ...
        include __DIR__ . '/../../views/layouts/wadir/header.php';
        include __DIR__ . '/../../views/pages/wadir/akun.php';
        include __DIR__ . '/../../views/layouts/wadir/footer.php';
    }
    ...
    public function update()
    {
        if ($_SERVER['REQUEST_METHOD'] === 'POST') {
            ...
            header('Location: /docutrack/public/wadir/akun?success=1');
            exit;
        }

        header('Location: /docutrack/public/wadir/akun');
        exit;
    }
}