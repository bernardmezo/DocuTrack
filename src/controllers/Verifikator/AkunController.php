...
class VerifikatorAkunController
{
    ...
    public function index($options = [])
    {
        ...
        include __DIR__ . '/../../views/layouts/verifikator/header.php';
        include __DIR__ . '/../../views/pages/verifikator/akun.php';
        include __DIR__ . '/../../views/layouts/verifikator/footer.php';
    }
    ...
    public function update()
    {
        if ($_SERVER['REQUEST_METHOD'] === 'POST') {
            ...
            header('Location: /docutrack/public/verifikator/akun?success=1');
            exit;
        }

        header('Location: /docutrack/public/verifikator/akun');
        exit;
    }
}