...
<body class="bg-gray-100 flex items-center justify-center h-screen">
    <div class="text-center bg-white p-12 rounded-lg shadow-lg">
        ...
        <h2 class="text-2xl font-semibold text-gray-800 mt-4">Kesalahan Server Internal</h2>
        <p class="text-gray-600 mt-2">Terjadi kesalahan pada server. Tim kami telah diberitahu dan sedang menanganinya.</p>
