...
$rab_data = $rab_data ?? [];
$back_url = $back_url ?? '/docutrack/public/ppk/dashboard'; 
    ...
    <section class="bg-white p-4 md:p-10 rounded-2xl shadow-lg overflow-hidden mb-8">
        ...
        <form id="form-PPK-approval" action="#" method="POST">
            ...
            <div class="flex flex-col sm:flex-row justify-between items-center mt-10 pt-6 border-t border-gray-200 gap-4">
                ...
                <?php if ($is_menunggu): ?>
                    <button type="button" id="btn-setujui-PPK" class="w-full sm:w-auto inline-flex items-center justify-center gap-2 bg-green-600 text-white font-semibold px-5 py-2.5 rounded-lg shadow-md hover:bg-green-700 transition-all duration-300 transform hover:-translate-y-0.5">
