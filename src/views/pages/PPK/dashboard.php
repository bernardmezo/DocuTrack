            ...
            <table class="w-full min-w-[700px]">
                ...
                <tbody id="ppk-table-body" class="divide-y divide-gray-100">
                    ...
                    <?php else: ?>
                        ...
                        ?>
                            <tr class='ppk-row <?php echo $row_class; ?> hover:bg-gray-100 transition-colors' data-nama="<?php echo htmlspecialchars(strtolower($item['nama'])); ?>">
...
<script>
    document.addEventListener('DOMContentLoaded', () => {
        const searchInput = document.getElementById('search-ppk-input');
        const tableBody = document.getElementById('ppk-table-body');
        const allRows = tableBody ? Array.from(tableBody.querySelectorAll('tr.ppk-row')) : [];
