...
?>
    ...
    <div class="min-h-screen p-4 md:p-8">
        ...
        <div class="max-w-7xl mx-auto mb-6">
            <a href="javascript:history.back()" class="inline-flex items-center bg-white text-gray-700 px-5 py-3 rounded-xl card-shadow hover:text-blue-600 hover:shadow-md transition-all duration-300 group">
                ...
                <form id="profileForm" action="/docutrack/public/admin/akun/update" method="POST" enctype="multipart/form-data" class="contents lg:col-span-2">
                    ...
                    <div class="lg:col-span-2">
                        ...
                        <div id="profileHeader" 
                             class="gradient-header rounded-3xl p-8 mb-6 relative text-white card-shadow min-h-[220px] flex flex-col justify-center"
                             style="background: <?php echo $user['header_bg']; ?>;">
    ...
    <script>
        ...
        // ===============================================
        // 2. PREVIEW BACKGROUND HEADER (LOGIKA BARU)
        // ===============================================
