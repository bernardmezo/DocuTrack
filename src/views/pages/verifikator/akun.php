...
$user = $user ?? [
    'username' => $_SESSION['username'] ?? 'Verifikatorski',
    'email' => $_SESSION['email'] ?? '',
    'role' => $_SESSION['role'] ?? 'Verifikator',
    ...
    <div class="min-h-screen p-4 md:p-8">
        ...
        <div class="max-w-7xl mx-auto">
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <form id="profileForm" action="/docutrack/public/verifikator/akun/update" method="POST" enctype="multipart/form-data" class="contents lg:col-span-2">
