...
function submitForm() {
    try {
        ...
        //     html: `
        //         <div class="text-left">
        //             <p class="mb-3">Anda akan mencairkan dana sebanyak <strong>${tanggalInputs.length} tahap</strong> dengan total:</p>
        //             <div class="bg-blue-50 p-3 rounded border border-blue-200">
        //                 <p class="text-2xl font-bold text-blue-600">Rp ${totalNominal.toLocaleString('id-ID')}</p>
        //             </div>
        //             <p class="mt-3 text-sm text-gray-600">Tindakan ini tidak dapat dibatalkan.</p>
        //         </div>
        //     `,
        ...
        //         console.log('=== FORM SUBMIT ===');
        //         console.log('KAK ID:', kakIdEl.value);
        //         console.log('Total Tahapan:', tanggalInputs.length);
