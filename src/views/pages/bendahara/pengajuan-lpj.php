...
<main class="main-content font-poppins p-4 md:p-7 -mt-8 md:-mt-20 max-w-7xl mx-auto w-full">
    ...
    <div class="mb-4 sm:mb-6 bg-green-50 border-l-4 border-green-500 p-3 sm:p-4 rounded-r-lg shadow-sm">
        <div class="flex items-start sm:items-center">
            <i class="fas fa-check-circle text-green-500 mr-2 sm:mr-3 mt-0.5 sm:mt-0"></i>
            <p class="text-sm sm:text-base text-green-700 font-medium"><?= htmlspecialchars($success_message) ?></p>
        </div>
    </div>
    <?php endif; ?>
    ...
    <div class="mb-4 sm:mb-6 bg-red-50 border-l-4 border-red-500 p-3 sm:p-4 rounded-r-lg shadow-sm">
        <div class="flex items-start sm:items-center">
            <i class="fas fa-exclamation-circle text-red-500 mr-2 sm:mr-3 mt-0.5 sm:mt-0"></i>
            <p class="text-sm sm:text-base text-red-700 font-medium"><?= htmlspecialchars($error_message) ?></p>
        </div>
    </div>
    <?php endif; ?>

    <!-- Table LPJ - RESPONSIVE -->
    <section class="bg-white rounded-xl shadow-lg overflow-hidden mb-8 flex flex-col">
        ...
        <div class="p-4 sm:p-5 md:p-6 border-b border-gray-200 flex-shrink-0">
            ...
            <div class="mt-3 sm:mt-4 relative">
                <input type="text" id="search-lpj" placeholder="Cari nama kegiatan, mahasiswa, atau NIM..." class="w-full pl-9 sm:pl-10 pr-4 py-2 border border-gray-300 rounded-lg text-sm focus:ring-2 focus:ring-green-500 focus:border-green-500 transition-all duration-200">
                ...
                <table class="min-w-full" id="table-lpj">
                    <thead class="bg-gradient-to-r from-green-50 to-emerald-50 sticky top-0 z-10">
                        <tr>
                            ...
                            <th class="px-3 sm:px-4 md:px-6 py-3 sm:py-4 text-left text-xs font-bold text-gray-700 uppercase tracking-wider whitespace-nowrap">Tenggat LPJ</th>
                    ...
                    <tbody id="tbody-lpj" class="divide-y divide-gray-100 bg-white">
        ...
        <div class="md:hidden overflow-y-auto" style="max-height: 500px;">
            <div id="mobile-lpj-list" class="p-3 space-y-3">
                <!-- Mobile cards will be populated by JavaScript -->
            </div>
        </div>

        <!-- Pagination LPJ - Responsive -->
...
<style>
    ...
    /* Tenggat Badge Styling for Mobile */
    .tenggat-badge {
        padding: 0.375rem 0.75rem;
        border-radius: 8px;
        font-size: 0.75rem;
