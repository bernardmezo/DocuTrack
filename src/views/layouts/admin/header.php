                ...
                <div class="hidden lg:flex items-center justify-center flex-1">
                    <nav>
                        <ul class="flex gap-2 xl:gap-4">
                            <li>
                                <a href="/docutrack/public/admin/dashboard"
                                   class="flex items-center gap-2 px-3 xl:px-4 py-2 rounded-full transition-all duration-200 text-sm xl:text-base whitespace-nowrap <?= isActive($current, '/docutrack/public/admin/dashboard') ?>">
                                    <i class="fas fa-th-large text-xs xl:text-sm"></i> Dashboard
                                </a>
                            </li>
                            <li>
                                <a href="/docutrack/public/admin/pengajuan-usulan"
                                   class="flex items-center gap-2 px-3 xl:px-4 py-2 rounded-full transition-all duration-200 text-sm xl:text-base whitespace-nowrap <?= isActive($current, '/docutrack/public/admin/pengajuan-usulan') ?>">
                                    <i class="fas fa-file-signature text-xs xl:text-sm"></i> Pengajuan Usulan
                                </a>
                            </li>
                            <li>
                                <a href="/docutrack/public/admin/pengajuan-kegiatan"
                                   class="flex items-center gap-2 px-3 xl:px-4 py-2 rounded-full transition-all duration-200 text-sm xl:text-base whitespace-nowrap <?= isActive($current, '/docutrack/public/admin/pengajuan-kegiatan') ?>">
                                    <i class="fas fa-file-invoice text-xs xl:text-sm"></i> Pengajuan Kegiatan
                                </a>
                            </li>
                            <li>
                                <a href="/docutrack/public/admin/pengajuan-lpj"
                                   class="flex items-center gap-2 px-3 xl:px-4 py-2 rounded-full transition-all duration-200 text-sm xl:text-base whitespace-nowrap <?= isActive($current, '/docutrack/public/admin/pengajuan-lpj') ?>">
        ...
        <div id="mobile-menu" class="md:hidden hidden mt-4 pb-2 max-w-7xl mx-auto">
            <nav class="bg-white/10 backdrop-blur-sm rounded-lg overflow-hidden shadow-lg">
                <ul class="divide-y divide-white/10">
                    ...
                    <li>
                        <a href="/docutrack/public/admin/dashboard"
                           class="flex items-center gap-3 px-4 py-3 transition-all duration-200 <?= isActiveMobile($current, '/docutrack/public/admin/dashboard') ?>">
                    ...
                    <li>
                        <a href="/docutrack/public/admin/pengajuan-usulan"
                           class="flex items-center gap-3 px-4 py-3 transition-all duration-200 <?= isActiveMobile($current, '/docutrack/public/admin/pengajuan-usulan') ?>">
                    ...
                    <li>
                        <a href="/docutrack/public/admin/pengajuan-kegiatan"
                           class="flex items-center gap-3 px-4 py-3 transition-all duration-200 <?= isActiveMobile($current, '/docutrack/public/admin/pengajuan-kegiatan') ?>">
                    ...
                    <li>
                        <a href="/docutrack/public/admin/pengajuan-lpj"
                           class="flex items-center gap-3 px-4 py-3 transition-all duration-200 <?= isActiveMobile($current, '/docutrack/public/admin/pengajuan-lpj') ?>">
