<?php
// File: src/views/layouts/app/header.php
    ...
    <div class="top-section bg-gradient-to-l from-[#17A18A] via-[#006A9A] to-[#114177] p-4 sm:p-6 pb-4 md:pb-20 text-white shadow-lg">
        <header class="flex justify-between items-center pb-3 sm:pb-5 border-b border-white/20 max-w-7xl mx-auto">
            ...
            <div class="flex-shrink-0">
                <a href="/docutrack/public/admin/dashboard">
            ...
            <div class="hidden lg:flex items-center justify-center flex-1">
                <nav>
                    <ul class="flex gap-2 xl:gap-4">
                        <li>
                            <a href="/docutrack/public/admin/dashboard"
                            class="flex items-center gap-2 px-3 xl:px-4 py-2 rounded-full transition-colors text-sm xl:text-base whitespace-nowrap <?= isActive($current, '/admin/dashboard') ?>">
                                <i class="fas fa-th-large text-xs xl:text-sm"></i> Dashboard
                            </a>
                        </li>
                        <li>
                            <a href="/docutrack/public/admin/pengajuan-usulan"
                            class="flex items-center gap-2 px-3 xl:px-4 py-2 rounded-full transition-colors text-sm xl:text-base whitespace-nowrap <?= isActive($current, '/admin/pengajuan-usulan') ?>">
                                <i class="fas fa-file-signature text-xs xl:text-sm"></i> Pengajuan Usulan
                            </a>
                        </li>
                        <li>
                            <a href="/docutrack/public/admin/pengajuan-kegiatan"
                            class="flex items-center gap-2 px-3 xl:px-4 py-2 rounded-full transition-colors text-sm xl:text-base whitespace-nowrap <?= isActive($current, '/admin/pengajuan-kegiatan') ?>">
                                <i class="fas fa-file-invoice text-xs xl:text-sm"></i> Pengajuan Kegiatan
                            </a>
                        </li>
                        <li>
                            <a href="/docutrack/public/admin/pengajuan-lpj"
                            class="flex items-center gap-2 px-3 xl:px-4 py-2 rounded-full transition-colors text-sm xl:text-base whitespace-nowrap <?= isActive($current, '/admin/pengajuan-lpj') ?>">
                                <i class="fas fa-book-open text-xs xl:text-sm"></i> Pengajuan LPJ
                            </a>
                        </li>
                    </ul>
                </nav>
            ...
            <div class="flex items-center gap-3 sm:gap-4 md:gap-6">
                ...
                <!-- Notifikasi -->
                <div class="relative text-base sm:text-lg md:text-xl text-gray-200 hover:text-white cursor-pointer transition-colors duration-200">
                ...
                <button
                    ...
                    class="lg:hidden relative z-50 text-white p-1.5 sm:p-2 rounded-lg hover:bg-white/10 transition-colors duration-200 flex items-center justify-center w-9 h-9 sm:w-10 sm:h-10"
                    aria-label="Toggle Menu"
                    aria-expanded="false">
                    <i id="menu-icon" class="fas fa-bars text-lg sm:text-xl transition-transform duration-300"></i>
                </button>
        ...
        <div id="mobile-menu" class="md:hidden hidden mt-4 pb-2 max-w-7xl mx-auto">
            <nav class="bg-white/10 backdrop-blur-sm rounded-lg overflow-hidden shadow-lg">
                <ul class="divide-y divide-white/10">
                    ...
                    <li>
                        <a href="/docutrack/public/admin/dashboard"
                        class="flex items-center gap-3 px-4 py-3 transition-colors <?= isActiveMobile($current, '/admin/dashboard') ?>">
                    ...
                    <li>
                        <a href="/docutrack/public/admin/pengajuan-usulan"
                        class="flex items-center gap-3 px-4 py-3 transition-colors <?= isActiveMobile($current, '/admin/pengajuan-usulan') ?>">
                            <i class="fas fa-file-signature text-base w-5"></i>
                            <span class="text-sm">Pengajuan Usulan</span>
                        </a>
                    </li>
                    <li>
                        <a href="/docutrack/public/admin/pengajuan-kegiatan"
                        class="flex items-center gap-3 px-4 py-3 transition-colors <?= isActiveMobile($current, '/admin/pengajuan-kegiatan') ?>">
                    ...
                    <li>
                        <a href="/docutrack/public/admin/pengajuan-lpj"
                        class="flex items-center gap-3 px-4 py-3 transition-colors <?= isActiveMobile($current, '/admin/pengajuan-lpj') ?>">
