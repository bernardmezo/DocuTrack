...
$userRole = $userData['role'] ?? $_SESSION['user_role'] ?? 'super administrator';
...
<head>
    ...
    <title><?php echo htmlspecialchars($title ?? 'Super Admin Dashboard'); ?></title>
        ...
        <header class="flex justify-between items-center pb-3 sm:pb-5 border-b border-white/20 max-w-7xl mx-auto">
            ...
            <div class="flex items-center gap-3 sm:gap-4 md:gap-10 flex-1 min-w-0">
                ...
                <div class="w-32 sm:w-40 md:w-auto flex-shrink-0">
                    <a href="/docutrack/public/superadmin/dashboard">
                ...
                <div class="hidden lg:flex items-center justify-center flex-1">
                    <nav>
                        <ul class="flex gap-2 xl:gap-4">
                            <li>
                                <a href="/docutrack/public/superadmin/dashboard"
                                   class="flex items-center gap-2 px-3 xl:px-4 py-2 rounded-full transition-colors text-sm xl:text-base whitespace-nowrap <?= isActive($current, '/superadmin/dashboard'); ?>">
                                    <i class="fas fa-th-large text-xs xl:text-sm"></i> Dashboard
                                </a>
                            </li>
                            <li>
                                <a href="/docutrack/public/superadmin/kelola-akun"
                                   class="flex items-center gap-2 px-3 xl:px-4 py-2 rounded-full transition-colors text-sm xl:text-base whitespace-nowrap <?= isActive($current, '/superadmin/kelola-akun'); ?>">
                                    <i class="fas fa-users-cog text-xs xl:text-sm"></i> Kelola Akun
                                </a>
                            </li>
                            <li>
                                <a href="/docutrack/public/superadmin/monitoring"
                                   class="flex items-center gap-2 px-3 xl:px-4 py-2 rounded-full transition-colors text-sm xl:text-base whitespace-nowrap <?= isActive($current, '/superadmin/monitoring'); ?>">
                                    <i class="fas fa-desktop text-xs xl:text-sm"></i> Monitoring
                                </a>
                            </li>
                            <li>
                                <a href="/docutrack/public/superadmin/buat-iku"
                                   class="flex items-center gap-2 px-3 xl:px-4 py-2 rounded-full transition-colors text-sm xl:text-base whitespace-nowrap <?= isActive($current, '/superadmin/buat-iku'); ?>">
                                    <i class="fas fa-book-open text-xs xl:text-sm"></i> Buat IKU
                                </a>
                            </li>
                        </ul>
                    </nav>
            ...
            <div class="flex items-center gap-2 sm:gap-4 md:gap-6">
                ...
                <!-- Notifikasi -->
                <div class="relative text-lg sm:text-xl text-gray-200 hover:text-white cursor-pointer transition-colors duration-200">
                    <i class="fas fa-bell"></i>
                    <span class="absolute -top-1 -right-1 sm:-top-1.5 sm:-right-1.5 flex h-3.5 w-3.5 sm:h-4 sm:w-4 items-center justify-center rounded-full bg-red-600 text-[8px] sm:text-[9px] font-bold text-white ring-1 sm:ring-2 ring-[#0A4A7F]">
                        10
                    </span>
                </div>
        ...
        <div id="mobile-menu" class="md:hidden hidden mt-4 pb-2 max-w-7xl mx-auto">
            <nav class="bg-white/10 backdrop-blur-sm rounded-lg overflow-hidden shadow-lg">
                <ul class="divide-y divide-white/10">
                    ...
                    <li>
                        <a href="/docutrack/public/superadmin/dashboard"
                           class="flex items-center gap-3 px-4 py-3 transition-colors <?php echo (strpos($current, '/superadmin/dashboard') !== false) ? 'bg-white/20 text-white font-semibold' : 'text-gray-200 hover:bg-white/10'; ?>">
                    ...
                    <li>
                        <a href="/docutrack/public/superadmin/kelola-akun"
                           class="flex items-center gap-3 px-4 py-3 transition-colors <?php echo (strpos($current, '/superadmin/kelola-akun') !== false) ? 'bg-white/20 text-white font-semibold' : 'text-gray-200 hover:bg-white/10'; ?>">
                            <i class="fas fa-users-cog text-base w-5"></i>
                            <span class="text-sm">Kelola Akun</span>
                        </a>
                    </li>
                    <li>
                        <a href="/docutrack/public/superadmin/monitoring"
                           class="flex items-center gap-3 px-4 py-3 transition-colors <?php echo (strpos($current, '/superadmin/monitoring') !== false) ? 'bg-white/20 text-white font-semibold' : 'text-gray-200 hover:bg-white/10'; ?>">
                            <i class="fas fa-desktop text-base w-5"></i>
                            <span class="text-sm">Monitoring</span>
                        </a>
                    </li>
                    <li>
                        <a href="/docutrack/public/superadmin/buat-iku"
                           class="flex items-center gap-3 px-4 py-3 transition-colors <?php echo (strpos($current, '/superadmin/buat-iku') !== false) ? 'bg-white/20 text-white font-semibold' : 'text-gray-200 hover:bg-white/10'; ?>">
                            <i class="fas fa-book-open text-base w-5"></i>
                            <span class="text-sm">Buat IKU</span>
                        </a>
                    </li>
