    ...
    <footer class="relative w-full bg-white">
        ...
        <div class="w-full leading-none z-0">
            <svg class="w-full h-auto max-h-[450px] object-cover lg:min-h-0" viewBox="0 0 1440 534" fill="none" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="none">
                <path d="M916.136 106.928C531.374 -88.8183 240.667 34.5848 0 83.8337V534H1440V83.8337C1304.74 133.083 1065.74 183.038 916.136 106.928Z" fill="url(#paint0_linear_2739_4069)"/>
                <defs>
                    <linearGradient id="paint0_linear_2739_4069" x1="720" y1="0" x2="720" y2="534" gradientUnits="userSpaceOnUse">
        ...
        <div class="absolute bottom-0 left-0 w-full h-full flex flex-col justify-end pb-8 px-6 lg:px-16 z-10">
            
            <div class="max-w-7xl w-full mx-auto">
                <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 mb-8 text-white">
                    ...
                    <div class="lg:col-span-5 space-y-4">
                        ...
                        <p class="text-white/90 text-sm leading-relaxed pr-0 lg:pr-12 font-light">
                        ...
                        <div class="flex items-center gap-2 pt-2">
                            ...
                            <span class="text-sm font-medium">@politekniknegerijakarta</span>
                        </div>
                    </div>
                    ...
                    <div class="lg:col-span-4">
                        ...
                        <ul class="space-y-3">
                            <li class="flex items-start gap-3">
                                <i class="fas fa-phone-alt mt-1 text-sm"></i>
                                <span class="text-white/90 text-sm">+62 821-356-278</span>
                            </li>
                            <li class="flex items-start gap-3">
                                <i class="fas fa-envelope mt-1 text-sm"></i>
                                <span class="text-white/90 text-sm">humas@pnj.sch.id</span>
                            </li>
                            <li class="flex items-start gap-3">
                                <i class="fas fa-map-marker-alt mt-1 text-sm"></i>
                    ...
                    <div class="lg:col-span-3">
                        <h3 class="text-xl font-bold mb-4">Landing Page</h3>
                        <ul class="space-y-2">
                            <li><a href="#" class="text-white/90 text-sm hover:text-white hover:underline transition-all">Home</a></li>
                            <li><a href="#" class="text-white/90 text-sm hover:text-white hover:underline transition-all">About</a></li>
                            <li><a href="#" class="text-white/90 text-sm hover:text-white hover:underline transition-all">Detail</a></li>
                            <li><a href="#" class="text-white/90 text-sm hover:text-white hover:underline transition-all">Proses</a></li>
                        </ul>
                    </div>
...
// --- 3. FUNGSI POPUP (Global Functions) ---
function openLoginPopup() {
    const loginPopup = document.getElementById('popup-login');
    if (loginPopup) {
        loginPopup.classList.remove('hidden');
        loginPopup.classList.add('flex');
        console.log('Login popup opened'); // Debug
    } else {
        console.error('Popup login tidak ditemukan!'); // Debug
    }
}
