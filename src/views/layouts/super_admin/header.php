        ...
        <div class="top-section bg-gradient-to-l from-[#17A18A] via-[#006A9A] to-[#114177] p-6 pb-4 md:pb-20 text-white shadow-lg">
            <header class="flex justify-between font-poppins items-center pb-5 border-b border-white/20 max-w-7xl mx-auto">
                ...
                <div class="flex items-center gap-4 md:gap-10 flex-1">
                    ...
                    <div class="w-40 md:w-auto">
                        <a href="/docutrack/public/superadmin/dashboard"> <!-- Link logo ke dashboard -->
                        ...
                        <nav class="hidden md:block">
                            <ul class="flex gap-4">
                                <li>
                                    ...
                                    class="flex items-center gap-2 px-4 py-2 rounded-full transition-colors <?= isActive($current, '/superadmin/dashboard'); ?>">
                                        <i class="fas fa-th-large text-sm"></i> Dashboard
                                    </a>
                                </li>
                                <li>
                                    <a href="/docutrack/public/superadmin/kelola-akun" 
                                    class="flex items-center gap-2 px-4 py-2 rounded-full transition-colors <?= isActive($current, '/superadmin/kelola-akun'); ?>">
                                        <i class="fas fa-users-cog text-sm"></i> Kelola Akun
                                    </a>
                                </li>
                                <li>
                                    <a href="/docutrack/public/superadmin/monitoring" 
                                    class="flex items-center gap-2 px-4 py-2 rounded-full transition-colors <?= isActive($current, '/superadmin/monitoring'); ?>">
                                        <i class="fas fa-desktop text-sm"></i> Monitoring
                                    </a>
                                </li>
                                <li>
                                    <a href="/docutrack/public/superadmin/buat-iku" 
                                    class="flex items-center gap-2 px-4 py-2 rounded-full transition-colors <?= isActive($current, '/superadmin/buat-iku'); ?>">
            ...
            <div id="mobile-bendahara-menu" class="md:hidden hidden max-w-7xl mx-auto pt-4 pb-2">
                <div class="px-2 space-y-1">
                    <a href="/docutrack/public/superadmin/dashboard" class="flex items-center gap-2 px-3 py-2 rounded-md text-base font-medium text-gray-200 hover:bg-white/10 hover:text-white"><i class="fas fa-th-large text-sm w-5 text-center"></i> Dashboard</a>
                    <a href="/docutrack/public/superadmin/kelola-akun" class="flex items-center gap-2 px-3 py-2 rounded-md text-base font-medium text-gray-200 hover:bg-white/10 hover:text-white"><i class="fas fa-users-cog text-sm w-5 text-center"></i> Kelola Akun</a>
                    <a href="/docutrack/public/superadmin/monitoring" class="flex items-center gap-2 px-3 py-2 rounded-md text-base font-medium text-gray-200 hover:bg-white/10 hover:text-white"><i class="fas fa-desktop text-sm w-5 text-center"></i> Monitoring</a>
                    <a href="/docutrack/public/superadmin/buat-iku" class="flex items-center gap-2 px-3 py-2 rounded-md text-base font-medium text-gray-200 hover:bg-white/10 hover:text-white"><i class="fas fa-book-open text-sm w-5 text-center"></i> Buat IKU</a>
                </div>
            </div>
