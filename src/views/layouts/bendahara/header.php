        ...
        <div id="mobile-menu" class="md:hidden hidden mt-4 pb-2 max-w-7xl mx-auto">
            <nav class="bg-white/10 backdrop-blur-sm rounded-lg overflow-hidden shadow-lg">
                <ul class="divide-y divide-white/10">
                    ...
                    <li>
                        <a href="/docutrack/public/bendahara/dashboard"
                           class="flex items-center gap-3 px-4 py-3 transition-all duration-200 <?= isActiveMobile($current, '/docutrack/public/bendahara/dashboard') ?>">
                    ...
                    <li>
                        <a href="/docutrack/public/bendahara/pencairan-dana"
                           class="flex items-center gap-3 px-4 py-3 transition-all duration-200 <?= isActiveMobile($current, '/docutrack/public/bendahara/pencairan-dana') ?>">
                    ...
                    <li>
                        <a href="/docutrack/public/bendahara/pengajuan-lpj"
                           class="flex items-center gap-3 px-4 py-3 transition-all duration-200 <?= isActiveMobile($current, '/docutrack/public/bendahara/pengajuan-lpj') ?>">
                    ...
                    <li>
                        <a href="/docutrack/public/bendahara/riwayat-verifikasi"
                           class="flex items-center gap-3 px-4 py-3 transition-all duration-200 <?= isActiveMobile($current, '/docutrack/public/bendahara/riwayat-verifikasi') ?>">
