            ...
            <div class="flex items-center gap-4 md:gap-6">
                ...
                <div class="relative">
                    <div id="profile-menu-button" class="flex items-center gap-3 cursor-pointer group">
                        <div class="w-10 h-10 rounded-full bg-cover ring-2"
                             style="background-image: url('https.../text=PY')"></div>
                        <div class="hidden sm:block">
                            <div class="font-semibold text-sm text-white">
                                <?= htmlspecialchars($_SESSION['user_name'] ?? 'Nama User') ?>
                            </div>
                            <div class="text-xs text-gray-300">
                                <?= htmlspecialchars(ucfirst($_SESSION['user_role'] ?? 'Role')) ?>
                            </div>
                        </div>
                    </div>
                    ...
                    <div id="profile-menu" class="absolute right-0 mt-3 w-48 bg-white rounded-lg shadow-xl py-2 z-50 hidden border border-gray-100">
                        <a href="#" class="flex items-center justify-between px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">
                            Akun Saya <i class="fas fa-cog text-gray-400"></i>
                        </a>
                        <a href="/docutrack/public/logout" class="flex items-center justify-between px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">
                            Logout <i class="fas fa-sign-out-alt text-gray-400"></i>
                        </a>
                    </div>
                </div>
