                ...
                <div class="hidden md:flex items-center justify-center flex-1">
                    <nav>
                        <ul class="flex gap-2 lg:gap-4">
                            <li>
                                <a href="/docutrack/public/verifikator/dashboard"
                                   class="flex items-center gap-2 px-3 xl:px-4 py-2 rounded-full transition-colors text-sm xl:text-base whitespace-nowrap <?= isActive($current, '/verifikator/dashboard') ?>">
                                    <i class="fas fa-th-large text-xs lg:text-sm"></i> Dashboard
                                </a>
                            </li>
                            <li>
                                <a href="/docutrack/public/verifikator/pengajuan-telaah"
                                   class="flex items-center gap-2 px-3 xl:px-4 py-2 rounded-full transition-colors text-sm xl:text-base whitespace-nowrap <?= isActive($current, '/verifikator/pengajuan-telaah') ?>">
                                    <i class="fas fa-file-import text-xs lg:text-sm"></i> Pengajuan Telaah
                                </a>
                            </li>
                            <li>
                                <a href="/docutrack/public/verifikator/riwayat-verifikasi"
                                   class="flex items-center gap-2 px-3 xl:px-4 py-2 rounded-full transition-colors text-sm xl:text-base whitespace-nowrap <?= isActive($current, '/verifikator/riwayat-verifikasi') ?>">
        ...
        <div id="mobile-menu" class="md:hidden hidden mt-4 pb-2 max-w-7xl mx-auto">
            <nav class="bg-white/10 backdrop-blur-sm rounded-lg overflow-hidden shadow-lg">
                <ul class="divide-y divide-white/10">
                    ...
                    <li>
                        <a href="/docutrack/public/verifikator/dashboard"
                           class="flex items-center gap-3 px-4 py-3 transition-colors <?= isActiveMobile($current, '/verifikator/dashboard') ?>">
                    ...
                    <li>
                        <a href="/docutrack/public/verifikator/pengajuan-telaah"
                           class="flex items-center gap-3 px-4 py-3 transition-colors <?= isActiveMobile($current, '/verifikator/pengajuan-telaah') ?>">
                    ...
                    <li>
                        <a href="/docutrack/public/verifikator/riwayat-verifikasi"
                           class="flex items-center gap-3 px-4 py-3 transition-colors <?= isActiveMobile($current, '/verifikator/riwayat-verifikasi') ?>">
