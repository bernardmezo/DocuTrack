<?php
// File: src/views/layouts/verifikator/header.php
...
<head>
    ...
    <title><?php echo htmlspecialchars($title ?? 'Verifikator Dashboard'); ?></title>
...
<div class="main-wrapper font-poppins">
    ...
    <div class="top-section bg-gradient-to-l from-[#17A18A] via-[#006A9A] to-[#114177] p-4 sm:p-6 pb-4 md:pb-20 text-white shadow-lg">
        <header class="flex justify-between items-center pb-3 sm:pb-5 border-b border-white/20 max-w-7xl mx-auto">
            ...
            <div class="flex items-center gap-3 sm:gap-4 md:gap-10 flex-1">
                <!-- Logo -->
                <div class="w-32 sm:w-40 md:w-auto flex-shrink-0">
                    <a href="/docutrack/public/verifikator/dashboard">
                        <svg class="w-full h-auto" viewBox="0 0 195 47" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="hidden md:flex items-center justify-center flex-1">
                    <nav>
                        <ul class="flex gap-2 lg:gap-4">
                            <li>
                                <a href="/docutrack/public/verifikator/dashboard"
                                   class="flex items-center gap-2 px-3 lg:px-4 py-2 rounded-full transition-all duration-200 text-sm lg:text-base <?= isActive($current, '/docutrack/public/verifikator/dashboard') ?>">
                                    <i class="fas fa-th-large text-xs lg:text-sm"></i> Dashboard
                                </a>
                            </li>
                            <li>
                                <a href="/docutrack/public/verifikator/pengajuan-telaah"
                                   class="flex items-center gap-2 px-3 lg:px-4 py-2 rounded-full transition-all duration-200 text-sm lg:text-base <?= isActive($current, '/docutrack/public/verifikator/pengajuan-telaah') ?>">
                                    <i class="fas fa-file-import text-xs lg:text-sm"></i> Pengajuan Telaah
                                </a>
                            </li>
                            <li>
                                <a href="/docutrack/public/verifikator/riwayat-verifikasi"
                                   class="flex items-center gap-2 px-3 lg:px-4 py-2 rounded-full transition-all duration-200 text-sm lg:text-base <?= isActive($current, '/docutrack/public/verifikator/riwayat-verifikasi') ?>">
                                    <i class="fas fa-history text-xs lg:text-sm"></i> Riwayat Verifikasi
                                </a>
                            </li>
                        </ul>
                    </nav>
            ...
            <div class="flex items-center gap-3 sm:gap-4 md:gap-6">
                ...
                <div class="relative text-lg sm:text-xl text-gray-200 hover:text-white cursor-pointer transition-colors duration-200">
                    ...
                    <span class="absolute -top-1 -right-1 sm:-top-1.5 sm:-right-1.5 flex h-3.5 w-3.5 sm:h-4 sm:w-4 items-center justify-center rounded-full bg-red-600 text-[8px] sm:text-[9px] font-bold text-white ring-2 ring-[#0A4A7F]">
                        10
                    </span>
                </div>
                ...
                <div class="relative hidden sm:block">
                    <div id="profile-menu-button" class="flex items-center gap-2 sm:gap-3 cursor-pointer group">
                        <div class="w-8 h-8 sm:w-10 sm:h-10 rounded-full bg-cover bg-center ring-2 ring-offset-2 ring-offset-[#0A4A7F] ring-white flex-shrink-0"
    ...
    class="md:hidden relative z-50 text-white p-2 rounded-lg hover:bg-white/10 transition-colors duration-200 flex items-center justify-center w-10 h-10"
        ...
        <div id="mobile-menu" class="md:hidden hidden mt-4 pb-2 max-w-7xl mx-auto">
            <nav class="bg-white/10 backdrop-blur-sm rounded-lg overflow-hidden shadow-lg">
                <ul class="divide-y divide-white/10">
                    ...
                    <li>
                        <a href="/docutrack/public/verifikator/dashboard"
                           class="flex items-center gap-3 px-4 py-3 transition-all duration-200 <?= isActiveMobile($current, '/docutrack/public/verifikator/dashboard') ?>">
                    ...
                    <li>
                        <a href="/docutrack/public/verifikator/pengajuan-telaah"
                           class="flex items-center gap-3 px-4 py-3 transition-all duration-200 <?= isActiveMobile($current, '/docutrack/public/verifikator/pengajuan-telaah') ?>">
                            <i class="fas fa-file-import text-base w-5"></i>
                            <span class="text-sm">Pengajuan Telaah</span>
                        </a>
                    </li>
                    <li>
                        <a href="/docutrack/public/verifikator/riwayat-verifikasi"
                           class="flex items-center gap-3 px-4 py-3 transition-all duration-200 <?= isActiveMobile($current, '/docutrack/public/verifikator/riwayat-verifikasi') ?>">
