        ...
        <div class="top-section bg-gradient-to-l from-[#17A18A] via-[#006A9A] to-[#114177] p-6 pb-4 md:pb-20 text-white shadow-lg">
                ...
                <div class="flex items-center gap-4 md:gap-10">
                    ...
                    <div class="flex items-center gap-4 md:gap-10">
                        <nav>
                            <ul class="flex gap-4">
                                <li>
                                    <a href="/docutrack/public/admin/dashboard" class="<?= isActive($current, '/admin/dashboard'); ?>">
                                        <i class="fas fa-th-large text-sm"></i> Dashboard
                                    </a>
                                </li>
                                <li>
                                    <a href="/docutrack/public/admin/pengajuan-usulan" class="<?= isActive($current, '/admin/pengajuan-usulan'); ?>">
                                        <i class="fas fa-file-signature text-sm"></i> Pengajuan Usulan
                                    </a>
                                </li>
                                <li>
                                    <a href="/docutrack/public/admin/pengajuan-kegiatan" class="<?= isActive($current, '/admin/pengajuan-kegiatan'); ?>">
                                        <i class="fas fa-file-invoice text-sm"></i> Pengajuan Kegiatan
                                    </a>
                                </li>
                                <li>
                                    <a href="/docutrack/public/admin/pengajuan-lpj" class="<?= isActive($current, '/admin/pengajuan-lpj'); ?>">
            ...
            <div id="mobile-admin-menu" class="md:hidden hidden max-w-7xl mx-auto pt-4 pb-2">
                <div class="px-2 space-y-1">
                    <a href="/docutrack/public/admin/dashboard" class="flex items-center gap-2 px-3 py-2 rounded-md text-base font-medium text-gray-200 hover:bg-white/10 hover:text-white transition-colors duration-200">
                        <i class="fas fa-th-large text-sm w-5 text-center"></i> Dashboard
                    </a>
                    <a href="/docutrack/public/admin/pengajuan-usulan" class="flex items-center gap-2 px-3 py-2 rounded-md text-base font-medium text-gray-200 hover:bg-white/10 hover:text-white">
                        <i class="fas fa-file-signature text-sm w-5 text-center"></i> Pengajuan Usulan
                    </a>
                    <a href="/docutrack/public/admin/pengajuan-kegiatan" class="flex items-center gap-2 px-3 py-2 rounded-md text-base font-medium text-gray-200 hover:bg-white/10 hover:text-white">
                        <i class="fas fa-file-invoice text-sm w-5 text-center"></i> Pengajuan Kegiatan
                    </a>
                    <a href="/docutrack/public/admin/pengajuan-lpj" class="flex items-center gap-2 px-3 py-2 rounded-md text-base font-medium text-gray-200 hover:bg-white/10 hover:text-white">
