        ...
        <div class="top-section bg-gradient-to-l from-[#17A18A] via-[#006A9A] to-[#114177] p-6 pb-4 md:pb-20 text-white shadow-lg">
            <header class="flex justify-between font-poppins items-center pb-5 border-b border-white/20 max-w-7xl mx-auto">
                ...
                <div class="flex items-center gap-4 md:gap-10">
                    ...
                    <div class="w-40 md:w-auto">
                        <a href="/docutrack/public/admin/dashboard"> <!-- Link logo ke dashboard -->
                ...
                <div class="flex items-center gap-4 md:gap-6">
                    ...
                    <button id="mobile-admin-menu-button" class="md:hidden p-2 rounded-md text-gray-200 hover:text-white hover:bg-white/10 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-white" aria-controls="mobile-admin-menu" aria-expanded="false">
                        <span class="sr-only">Buka menu utama</span>
                        <!-- Ikon Hamburger -->
                        <svg id="hamburger-admin-icon" class="block h-6 w-6" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 6h16M4 12h16m-7 6h7" /></svg>
                        <!-- Ikon Close (X) -->
                        <svg id="close-admin-icon" class="hidden h-6 w-6" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12" /></svg>
                    </button>
                </div>
            </header>
            ...
            <div id="mobile-admin-menu" class="md:hidden hidden max-w-7xl mx-auto pt-4 pb-2">
                <div class="px-2 space-y-1">
                    <a href="/docutrack/public/admin/dashboard" class="flex items-center gap-2 px-3 py-2 rounded-md text-base font-medium text-gray-200 hover:bg-white/10 hover:text-white"><i class="fas fa-th-large text-sm w-5 text-center"></i> Dashboard</a>
