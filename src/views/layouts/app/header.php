...
<head>
    ...
    <title><?php echo htmlspecialchars($title ?? 'Docutrack Admin'); ?></title>
        ...
        <div class="top-section bg-gradient-to-l from-[#17A18A] via-[#006A9A] to-[#114177] p-6 pb-4 md:pb-20 text-white shadow-lg">
            <header class="flex justify-between font-poppins items-center pb-5 border-b border-white/20 max-w-7xl mx-auto">
                    ...
                    <div class="flex items-center gap-4 md:gap-10">
                        <nav class="hidden md:block">
                            <ul class="flex gap-4">
                                <li>
                                    <a href="/docutrack/public/admin/dashboard" 
                                       class="flex items-center gap-2 px-4 py-2 rounded-full transition-colors <?= isActive($current, '/admin/dashboard'); ?>">
                                        <i class="fas fa-th-large text-sm"></i> Dashboard
                                    </a>
                                </li>
                                <li>
                                    <a href="/docutrack/public/admin/pengajuan-usulan" 
                                       class="flex items-center gap-2 px-4 py-2 rounded-full transition-colors <?= isActive($current, '/admin/pengajuan-usulan'); ?>">
                                        <i class="fas fa-file-signature text-sm"></i> Pengajuan Usulan
                                    </a>
                                </li>
                                <li>
                                    <a href="/docutrack/public/admin/pengajuan-kegiatan" 
                                       class="flex items-center gap-2 px-4 py-2 rounded-full transition-colors <?= isActive($current, '/admin/pengajuan-kegiatan'); ?>">
                                        <i class="fas fa-file-invoice text-sm"></i> Pengajuan Kegiatan
                                    </a>
                                </li>
                                <li>
                                    <a href="/docutrack/public/admin/pengajuan-lpj" 
                                       class="flex items-center gap-2 px-4 py-2 rounded-full transition-colors <?= isActive($current, '/admin/pengajuan-lpj'); ?>">
                                        <i class="fas fa-book-open text-sm"></i> Pengajuan LPJ
                                    </a>
                                </li>
                            </ul>
                        </nav>
                ...
                <div class="flex items-center gap-4 md:gap-6">
                    ...
                    <button id="mobile-admin-menu-button" class="md:hidden p-2 rounded-md text-gray-200 hover:text-white hover:bg-white/10 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-white transition-all duration-200">
                        <span class="sr-only">Buka menu utama</span>
                        <svg id="hamburger-admin-icon" class="block h-6 w-6" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 6h16M4 12h16m-7 6h7" />
                        </svg>
                        <svg id="close-admin-icon" class="hidden h-6 w-6" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <div id="mobile-admin-menu" class="md:hidden hidden max-w-7xl mx-auto pt-4 pb-2">
                <div class="px-2 space-y-1">
                    <a href="/docutrack/public/admin/dashboard" 
                       ...
                       <?= strpos($current, '/docutrack/public/admin/dashboard') === 0 ? 'bg-white/10 text-white' : 'text-gray-200 hover:bg-white/10 hover:text-white' ?>">
                        <i class="fas fa-th-large text-sm w-5 text-center"></i> Dashboard
                    </a>
                    <a href="/docutrack/public/admin/pengajuan-usulan" 
                       class="flex items-center gap-2 px-3 py-2 rounded-md text-base font-medium 
                       <?= strpos($current, '/docutrack/public/admin/pengajuan-usulan') === 0 ? 'bg-white/10 text-white' : 'text-gray-200 hover:bg-white/10 hover:text-white' ?>">
                        <i class="fas fa-file-signature text-sm w-5 text-center"></i> Pengajuan Usulan
                    </a>
                    <a href="/docutrack/public/admin/pengajuan-kegiatan" 
                       class="flex items-center gap-2 px-3 py-2 rounded-md text-base font-medium 
                       <?= strpos($current, '/docutrack/public/admin/pengajuan-kegiatan') === 0 ? 'bg-white/10 text-white' : 'text-gray-200 hover:bg-white/10 hover:text-white' ?>">
                        <i class="fas fa-file-invoice text-sm w-5 text-center"></i> Pengajuan Kegiatan
                    </a>
                    <a href="/docutrack/public/admin/pengajuan-lpj" 
                       class="flex items-center gap-2 px-3 py-2 rounded-md text-base font-medium 
                       <?= strpos($current, '/docutrack/public/admin/pengajuan-lpj') === 0 ? 'bg-white/10 text-white' : 'text-gray-200 hover:bg-white/10 hover:text-white' ?>">
                        <i class="fas fa-book-open text-sm w-5 text-center"></i> Pengajuan LPJ
                    </a>
