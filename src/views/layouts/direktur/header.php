...
// 3. Tentukan Role
$userRole = $userData['role'] ?? $_SESSION['user_role'] ?? 'direktur';
...
<head>
    ...
    <title><?php echo htmlspecialchars($title ?? 'Direktur Dashboard'); ?></title>
...
<div class="main-wrapper font-poppins">
    <div class="top-section bg-gradient-to-l from-[#17A18A] via-[#006A9A] to-[#114177] p-4 sm:p-6 pb-4 md:pb-20 text-white shadow-lg">
        <header class="flex justify-between items-center pb-3 sm:pb-5 border-b border-white/20 max-w-7xl mx-auto">
                ...
                <div class="hidden lg:flex items-center justify-center flex-1">
                    <nav>
                        <ul class="flex gap-2 xl:gap-4">
                            <li>
                                <a href="/docutrack/public/direktur/dashboard"
                                   class="flex items-center gap-2 px-3 xl:px-4 py-2 rounded-full transition-all duration-200 text-sm xl:text-base whitespace-nowrap <?= isActive($current, '/docutrack/public/direktur/dashboard') ?>">
                                    <i class="fas fa-th-large text-xs xl:text-sm"></i> Dashboard
                                </a>
                            </li>
                            <li>
                                <a href="/docutrack/public/direktur/monitoring"
                                   class="flex items-center gap-2 px-3 xl:px-4 py-2 rounded-full transition-all duration-200 text-sm xl:text-base whitespace-nowrap <?= isActive($current, '/docutrack/public/direktur/monitoring') ?>">
            ...
            <div class="flex items-center gap-2 sm:gap-4 md:gap-6">
                ...
                <div class="relative" id="notification-container">
                    <div id="notification-icon-button" class="relative text-lg sm:text-xl text-gray-200 hover:text-white cursor-pointer transition-colors duration-200">
                        <i class="fas fa-bell"></i>
                        <span id="notification-count" class="absolute -top-1 -right-1 sm:-top-1.5 sm:-right-1.5 flex h-3.5 w-3.5 sm:h-4 sm:w-4 items-center justify-center rounded-full bg-red-600 text-[8px] sm:text-[9px] font-bold text-white ring-1 sm:ring-2 ring-[#0A4A7F]">
                            10
                        </span>
                    </div>
        ...
        <!-- Mobile Menu -->
        <div id="mobile-menu" class="lg:hidden hidden mt-4 pb-2 max-w-7xl mx-auto">
            <nav class="bg-white/10 backdrop-blur-sm rounded-lg overflow-hidden shadow-lg">
                <ul class="divide-y divide-white/10">
                    ...
                    <li>
                        <a href="/docutrack/public/direktur/dashboard"
                           class="flex items-center gap-3 px-4 py-3 transition-all duration-200 <?= isActiveMobile($current, '/docutrack/public/direktur/dashboard') ?>">
                    ...
                    <li>
                        <a href="/docutrack/public/direktur/monitoring"
                           class="flex items-center gap-3 px-4 py-3 transition-all duration-200 <?= isActiveMobile($current, '/docutrack/public/direktur/monitoring') ?>">
