...
$iku_data = $iku_data ?? $iku_array ?? [];
$indikator_data = $indikator_data ?? $indikator ?? [];
$rab_data = $rab_data ?? $rab ?? [];
$kode_mak = $kode_mak ?? '';
...
<head>
    ...
    <style>
        ...
        * {
        ...
        /* --- STYLE KHUSUS HALAMAN COVER BARU --- */
        ...
        .cover-footer {
            /* Menggunakan margin top besar untuk mendorong ke bawah,
               atau bisa menggunakan positioning jika wadah utamanya fixed height */
            margin-top: 150px;
            font-size: 12pt;
        }
...
<div class="cover-page-container">
    <img src="/docutrack/public/assets/images/logo/logoPnj.JPG" class="cover-logo" alt="Logo PNJ" style="width: 300px;">
    ...
    <tbody>
        <?php if (!empty($indikator_data)): ?>
            ...
            <tr>
                ...
                <td class="text-center"><?= htmlspecialchars($item['target'] ?? '0'); ?>%</td>
            </tr>
            <?php endforeach; ?>
        <?php else: ?>
            <tr>
            ...
            <tbody>
                <?php foreach ($items as $item): ?>
                    ...
                    <tr>
                        ...
                        <td><?= htmlspecialchars($vol1 ?? ''); ?></td>
                        <td><?= htmlspecialchars($sat1 ?? ''); ?></td>
                        <td><?= htmlspecialchars($vol2 ?? ''); ?></td>
                        <td><?= htmlspecialchars($sat2 ?? ''); ?></td>
...
<div class="section-header">V. Jumlah Dana yang Dicairkan</div>
